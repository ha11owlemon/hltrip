<template>
  <view>
    ...
    <view class="city-container">
      ...
      <view class="cities" v-if="!searchText">
        ...
        <view class="hotCities">
          <view class="title" id="hots">热门城市</view>
          <view class="hotCitiesList">
            <view class="hotCityItem" v-for="(item,index) in hotCities" hover-class="locationHover" hover-stay-time="900" @click="sendData(item)">{{item.cityName}}</view>
          </view>
        </view>

        <view class="citiesList">
          <view class="cityGroup " v-for="(item,index) in cities">
            <view class="groupLetter title" :id="item.group">{{item.group}}</view>
            <view class="cityName" v-for="(city,index) in item.cities" hover-class="cityHover" @click="sendData(city)">
              {{city.cityName}}
            </view>
          </view>
        </view>
    ...
    <!-- 侧边索引 -->
    <view class="sideBar" v-if="!searchText">
      <view class="letter"><a href="#hots">热门</a></view>
      <view class="letter" v-if="historyList.length!=0"><a href="#history">历史</a></view>
      <view class="letter" v-for="(item,index) in letterGroup" :key="item" hover-class="textHoverOrange" hover-stay-time="700">
        <a :href="'#'+item">{{item}}</a>
      </view>
    </view>
